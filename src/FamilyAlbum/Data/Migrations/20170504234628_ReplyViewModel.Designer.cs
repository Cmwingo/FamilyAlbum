...
namespace FamilyAlbum.Data.Migrations
{
    ...
    [Migration("20170504234628_ReplyViewModel")]
    partial class ReplyViewModel
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("FamilyAlbum.Models.Post", b =>
                {
                    ...
                    b.Property<int?>("PostFamilyFamilyId");
            ...
            modelBuilder.Entity("FamilyAlbum.Models.Post", b =>
                {
                    b.HasOne("FamilyAlbum.Models.Family", "PostFamily")
                        .WithMany("Posts")
                        .HasForeignKey("PostFamilyFamilyId");
            ...
            modelBuilder.Entity("FamilyAlbum.Models.Reply", b =>
                {
                    b.HasOne("FamilyAlbum.Models.Post")
                        .WithMany("Replies")
